...
<div class="sk-content">
	...
	<div class="mt-2 flex flex-col items-center justify-center gap-8">
		...
		<a
			class="gap-2 rounded-xl border border-donkey-300 bg-donkey-200 px-4 py-2 text-donkey-100 hover:bg-donkey-300 dark:border-donkey-600 dark:bg-donkey-900 dark:hover:bg-donkey-800"
			onpointerup={() => {
				vibrate();
			}}
			href="/projects"
		>
			<div class="flex items-center justify-center gap-2">
				...
				<p class="text-donkey-800 dark:text-donkey-300">Projects</p>
				<!-- {#await project then proj}
					{#if proj}
						<span class="text-center text-xs font-semibold dark:text-smithers-700">
